...
class UserInformationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBloodType()
    {
        ...
        $this->assertEquals(
            UserInformation::BLOOD_TYPE_B,
            $o->setBloodType(UserInformation::BLOOD_TYPE_B)->getBloodType()
        );
        $this->assertEquals(
            UserInformation::BLOOD_TYPE_O,
            $o->setBloodType(UserInformation::BLOOD_TYPE_O)->getBloodType()
        );
        $this->assertEquals(
            UserInformation::BLOOD_TYPE_AB,
            $o->setBloodType(UserInformation::BLOOD_TYPE_AB)->getBloodType()
        );
        $this->assertEquals(
    ...
    public function testConstellations()
    {
        ...
        $this->assertEquals(
            UserInformation::CONSTELLATION_TAURUS,
            $o->setConstellations(UserInformation::CONSTELLATION_TAURUS)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_GEMINI,
            $o->setConstellations(UserInformation::CONSTELLATION_GEMINI)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_CANCER,
            $o->setConstellations(UserInformation::CONSTELLATION_CANCER)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_LEO,
            $o->setConstellations(UserInformation::CONSTELLATION_LEO)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_VIRGO,
            $o->setConstellations(UserInformation::CONSTELLATION_VIRGO)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_LIBRA,
            $o->setConstellations(UserInformation::CONSTELLATION_LIBRA)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_SCORPIUS,
            $o->setConstellations(UserInformation::CONSTELLATION_SCORPIUS)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_SAGITTARIUS,
            $o->setConstellations(UserInformation::CONSTELLATION_SAGITTARIUS)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_CAPRICONUS,
            $o->setConstellations(UserInformation::CONSTELLATION_CAPRICONUS)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_AQUARIUS,
            $o->setConstellations(UserInformation::CONSTELLATION_AQUARIUS)->getConstellations()
        );
        $this->assertEquals(
            UserInformation::CONSTELLATION_PISCES,
